          ...
          <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
            <div className="px-6 pt-10 pb-24 sm:px-8 sm:pt-16 md:pt-20 lg:col-span-7 lg:px-0 lg:pt-24 lg:pb-28 xl:col-span-6">
              <div className="mx-auto max-w-lg lg:mx-0">
                <div className="flex items-center text-[#004030] mb-4">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
                  <Link
                    to="/admin/login"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-[#004030] hover:bg-[#005c45] transition-transform transform hover:scale-105 shadow-lg"
                  >
                    Access Admin Panel
                  </Link>
                  <Link
                    to="/"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 border border-transparent text-base font-medium rounded-md text-[#004030] bg-[#e6f2ef] hover:bg-[#cce6e1] transition"
                  >
                    ← Back to Main Site
                  </Link>
                </div>
